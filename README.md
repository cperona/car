...
- #### Quin d'aquests atributs poden ser inicialitzats des del constructor?:
  El atribut model (static) i el atribut power (final). L'unic que no pot ser inicialitzat és brand (static final)
...
- #### Quin afecta totes les instàncies de la classe?
  Quan es modifica el valor d'un atribut en una instància, canvi a el valor de l'atribut en totes les altres instàncies de la classe.
